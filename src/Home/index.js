...
import banner_4 from "./images/banner-4.png";


class Home extends React.Component {
    constructor(props){
        super(props);
        this.images = [banner_1, banner_2, banner_3, banner_4];
    ...
    render(){
        return (
            <div>
                ...
                <div className="Intro">AppleSmart, 我们的孩子就是我们的小苹果🍎，我们一起分享好老师,让好老师来教我们的小苹果🍎。”

AppleSmart是一个针对12年级以下的课外辅导学校。
